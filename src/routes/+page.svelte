...
<svelte:head>
	...
	<meta
		name="description"
		content="Karasax is a modern landing page built with Svelte and Tailwind CSS"
	/>
</svelte:head>
...
<style>
	...
	.animate-gradient-move-slow {
		background-size: 200% 200%;
		animation: gradient-move-slow 16s ease-in-out infinite;
	}
